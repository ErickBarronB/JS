...
class regConst{
    constructor(nombre, peso, altura, sexo, edad, actividadBaja, resultadoIMC, resultadoBMR, resultadoTDEE){
        this.nombre = nombre;
        this.peso = peso;
        this.altura = altura;
        this.sexo = sexo;
...
Registros.push(new regConst(nombre, peso, altura, sexo, edad, actividadBaja, resultadoIMC, resultadoTDEE, resultadoBMR))
